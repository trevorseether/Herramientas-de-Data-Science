...
#%%
FECHA = 'MARZO-23' #servirá para el nombre del archivo

#%%

os.chdir('C:\\Users\\sanmiguel38\\Desktop\\CESAR REPORTE MENSUAL\\MARZO 2023')

INSUMO = 'carteratotal14042023.xlsx'
MES_PASADO = 'SALDO_COOPACSANMIGUEL - FEBRERO-23_INC_CVV_DETALLADO.xlsx'
COBRANZA = 'Ingresos por Cobranza Marzo-23 - General.xlsx'
